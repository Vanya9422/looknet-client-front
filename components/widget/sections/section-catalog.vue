      ...
      .section-catalog__row.mt-0.pt-0
        .section-catalog__column.section-catalog__column_left
          .filter__nav.flex.flex_vertical
            button-filter.filter__title(:text="PAGE_CATALOG.filters" :counter="counter" @click.native="full = !full")
            .filter__nav-item
    ...
    .section-catalog__row.mt-0
      ...
      .section-catalog__column.section-catalog__column_right(:class="{full:full}")
        ...
        .section-catalog__column.section-catalog__column_right-inner
          .section-catalog__loading(v-if="PRODUCTS_LOADING && !products.length")
          ...
          catalog-pagination(v-if="!PRODUCTS_LOADING && products.length")
...
export default {
  ...
  methods: {
    ...
    clearFilter() {
      ...
      this.SET_FILTERS(0)
      this.$nuxt.$emit('reset-filter-event');
